...
split_concepts_df |> 
  ...
  mutate(combined_emotions = case_when(
    str_detect(concepts, "Serene|Tranquility|Relaxing|Reassuring|Comfortable|Melancholy|Nostalgia") ~ "Serene/Tranquility/Relaxing/Reassuring/Comfortable/Melancholy/Nostalgia",
    str_detect(concepts, "(E|I)nvigorating|Stimulating|Exciting|Energetic|Energyzing") ~ "Invigorating/Stimulating/Exciting/Energetic/Energyzing",
    str_detect(concepts, "Joyful|Happy|Cheerful") ~ "Joyful/Happy/Cheerful",
    #str_detect(concepts, "Freedom|Optimistic") ~ "Freedom/Optimistic",
    str_detect(concepts, "Freedom|Optimistic") ~ "Freedom/Optimistic",
    .default = "ERROR")
  ) |> 
  #group by price
